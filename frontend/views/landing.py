...
def render() -> None:
    # CSS espectacular para la landing
    st.markdown("""
    <style>
    ...
    .feature-card:hover {
        ...
        box-shadow: 0 8px 32px #7B5EA733;
    }
    ...
    .divider-magic::before {
        ...
        left: 0; right: 0;
        height: 1px;
        background: linear-gradient(90deg, transparent, #7B5EA7, transparent);
    }
    ...
    <div class="stats-row">
        <div class="stat-item">
            <span class="stat-number">{len(galeria)}</span>
            <span class="stat-label">Imágenes creadas</span>
        </div>
        <div class="stat-item">
            <span class="stat-number">{len(videos)}</span>
            <span class="stat-label">Videos generados</span>
        </div>
        <div class="stat-item">
    ...
    with col2:
        if st.button("🎨 Empezar a crear gratis", use_container_width=True, type="primary"):
    ...
    <div class="feature-grid">
        <div class="feature-card">
            ...
            <div class="feature-title">Generación de Imágenes</div>
            <div class="feature-desc">FLUX Dev con 15 estilos artísticos y 15 tipos de cámara cinematográfica</div>
        </div>
        <div class="feature-card">
            <span class="feature-icon">🎬</span>
            <div class="feature-title">Animación de Video</div>
            <div class="feature-desc">Convierte cualquier imagen en un clip de video con movimiento natural</div>
        </div>
        <div class="feature-card">
            <span class="feature-icon">🔍</span>
            <div class="feature-title">Reescalado 4K</div>
            <div class="feature-desc">Aumenta la resolución de tus imágenes 4x sin perder calidad con AuraSR</div>
        </div>
        <div class="feature-card">
            <span class="feature-icon">📈</span>
            <div class="feature-title">Inteligencia de Mercado</div>
            <div class="feature-desc">Analiza tendencias de tu nicho con IA en tiempo real. Gratis.</div>
        </div>
        <div class="feature-card">
            <span class="feature-icon">✍️</span>
            <div class="feature-title">Redactor LinkedIn</div>
            <div class="feature-desc">Posts profesionales optimizados para engagement con Llama 3.3</div>
        </div>
        <div class="feature-card">
            <span class="feature-icon">💰</span>
            <div class="feature-title">Control de Costes</div>
            <div class="feature-desc">Monitoriza tu gasto en APIs en tiempo real con alertas automáticas</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="pricing-grid">
        <div class="pricing-card">
            ...
            <div class="pricing-feature">❌ Video AI</div>
            <div class="pricing-feature">❌ Reescalado 4K</div>
        </div>
    ...
    with col2:
        ...
        <div style="text-align:center; margin-top:1rem;">
            <span style="font-family:'Raleway',sans-serif; font-size:0.8rem; color:#8A7AA0;">
                Construido con ❤️ por Javi García · Merlín AI 2.0
            </span>
        </div>
        """, unsafe_allow_html=True)
